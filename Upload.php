...
$n21=$_POST['u'];	
				...
				&&($n15=="w")||($n16=="w")||($n17=="w")||($n18=="w")||($n19=="w")||($n20=="w")||($n21=="w")*/)){
					...
					echo'<script> alert("Please make sure that you answered at least one question."); history.back();</script>';
					}
...
$filepath="uploaded_pic/".$filename;
		 ...
		 if($gender=="----"){
			...
			echo'<script> alert("Please make sure that you selected your gender"); history.back();</script>';
			}
		else{
				if(($filename=="")||($filetmp=="")||($filetype=="")||($filepath=="")){
					$ins=mysql_query("INSERT INTO PERSON (ID,Firstname, Lastname, Middlename, Address, Gender, Age, Score, Remarks,Imagename, Imagepath, Imagetype) VALUES ('','$fname','$lname','$mname','$address','$gender','$age','$scores','$remarks','default.png','uploaded_pic/default.png','PNG')");
				}
				else{
				
move_uploaded_file($filetmp,$filepath);
$ins=mysql_query("INSERT INTO PERSON (ID,Firstname, Lastname, Middlename, Address, Gender, Age, Score, Remarks,Imagename, Imagepath, Imagetype) VALUES ('','$fname','$lname','$mname','$address','$gender','$age','$scores','$remarks','$filename','$filepath','$filetype')");
				}
